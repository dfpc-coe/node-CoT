...
test('normalize_geojson - Point', async () => {
    ...
    assert.ok(feat.properties.start);
    feat.properties.start = '2025-07-14T03:00:57.112Z';
    assert.ok(feat.properties.time);
    feat.properties.time = '2025-07-14T03:00:57.112Z';
    assert.ok(feat.properties.stale);
...
test('normalize_geojson - LineString', async () => {
    const feat = await CoTParser.normalize_geojson({
...
test('normalize_geojson - Polygon', async () => {
    const feat = await CoTParser.normalize_geojson({
